...
map n <Plug>(easymotion-next) | map N <Plug>(easymotion-prev)
...
let g:cpp_class_scope_highlight = 1 | let g:cpp_class_decl_highlight = 1 " C/C++ improve
"   SEARCH
...
nmap <C-c> "+yy | vmap <C-c> "+y
nmap <C-v> "+pa | imap <C-v> <Esc>"+pa
