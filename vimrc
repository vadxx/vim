...
" Completions
Plug 'ervandew/supertab' | Plug 'jiangmiao/auto-pairs' | Plug 'scrooloose/nerdcommenter'
Plug 'mattn/emmet-vim', { 'for': ['html', 'javascript'] }
if has('nvim')
    Plug 'Shougo/deoplete.nvim', { 'do': ':UpdateRemotePlugins' }
else
    Plug 'Shougo/deoplete.nvim' | Plug 'roxma/nvim-yarp' | Plug 'roxma/vim-hug-neovim-rpc'
endif                                           " if not work : pip3 install --user pynvim
...
"   COMPLETE
set wildmenu    |  set completeopt="menuone,noselect,noinsert, nopreview"
